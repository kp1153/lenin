...
export default function Navbar() {
  ...
  return (
    <nav className="bg-amber-700 text-white text-center shadow sticky top-0 z-50">
      {/* Brand Name */}
      <div className="pt-4">
      ...
      {/* Navigation Menu */}
      <ul
        className={`flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 font-medium text-base pb-4 md:pb-6 transition-all duration-300 ${
